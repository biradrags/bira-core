...
_SKIP_MODULES = frozenset(
    {
        ...
        "bira_core.maxbot.dialogs.errors",
        "bira_core.maxbot.dialogs.notifier",
        "bira_core.maxbot.dialogs.widgets",
        "bira_core.maxbot._errors",
        "bira_core.di.db",
        "bira_core.di.redis",
        "bira_core.di.notify",
        "bira_core.di.warmup",
        ...
        "bira_core.db.url",
        "bira_core.dt.timezone",
        "bira_core.redis.client",
        "bira_core.testing.db",
        "bira_core.testing.providers_tg",
        "bira_core.testing.providers_max",
        "bira_core.tls.russian_trusted",
        "bira_core.notify.sender",
        "bira_core.kbd.wrap",
